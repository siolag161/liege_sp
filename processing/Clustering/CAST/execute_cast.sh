...
do
    CHR_DIR=$(basename $D)
    eval "${EXE}/clust_cast -i ${D}/${CHR_DIR}/casecontrol_filtered_data.csv -l ${D}/${CHR_DIR}/casecontrol_filtered_label.csv -o ${OUT_PATH}/CAST/${CHR_DIR} -c ${CAST} -s ${SIMI} -m ${MAX_DIST} "
